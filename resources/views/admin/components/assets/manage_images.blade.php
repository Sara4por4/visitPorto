...
<div class="input-group">
    <a href='' target='_blank' data-inputid="{{$path}}_path" class="btn btn-primary {{$path}}_path">
        <i class="fa fa-picture-o"></i> Adicionar
    </a>
</div>
...
<div id="{{$path}}_path">
        ...
        <div class="col-md-55">
            ...
            <div class="thumbnail">
                <div class="image view view-first">
                    <img style="width: 100%; display: block;" src="{{$asset->path}}" alt="image">
                    <div class="mask">
    ...
    @if(!empty($data) && is_array($data))
        ...
        <div class="col-md-55">
            ...
            <div class="thumbnail">
                <div class="image view view-first">
                    <img style="width: 100%; display: block;" src="{{url('/').$value}}" alt="image">
                    <div class="mask">
                        <div class="tools tools-bottom">
...
<script>
    ...
    function generatePathHolder(name_input, value)
    {
        ...
        return '<div class="col-md-55">' +
            ...
            '<div class="thumbnail">' +
            '<div class="image view view-first">' +
            '<img style="width: 100%; display: block;" src="{{url('/')}}'+ value +'" alt="image" id="holder">' +
            '<div class="mask">' +
            '<p></p>' +
            '<div class="tools tools-bottom">' +
    ...
    function processSelectedFile(file, requestingField) {
        ...
        var urls = $.map(file, function(f) {
            var path = '/'+f.path;
            if(getExtension(path) == 'mp4')
            {
                $('#'+requestingField).append(generatePathVideoHolder(input_key, path));
            } else {
