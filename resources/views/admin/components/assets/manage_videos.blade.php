...
<div class="input-group">
    <a href='' target='_blank' data-inputid="{{$path}}_path" class="btn btn-primary {{$path}}_path">
        <i class="fa fa-file-video-o"></i> Adicionar
    </a>
</div>
        ...
        <div class="col-md-55">
            ...
            <div class="thumbnail">
                <div class="image view view-first">
                    <img style="width: 100%; display: block;" src="/img/admin/wallpaper.jpg" alt="image">
                    <div class="mask">
...
<script>
    ...
    function generatePathVideoHolder(name_input, value)
    {
        ...
        return '<div class="col-md-55">' +
            ...
            '<div class="thumbnail">' +
            '<div class="image view view-first">' +
            '<img style="width: 100%; display: block;" src="/img/admin/wallpaper.jpg" alt="image" id="holder">' +
            '<div class="mask">' +
            '<p></p>' +
            '<div class="tools tools-bottom">' +
