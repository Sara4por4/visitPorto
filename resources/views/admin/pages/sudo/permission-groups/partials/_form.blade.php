        ...
        <div role="tabpanel" class="tab-pane active fade in" id="dados">
            <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                    {!! Form::text('name', null, ['class'=>'col-md-7 col-xs-12 form-control', 'id' => "name", 'placeholder' => "Ex: users, permissions"]) !!}
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                    {!! Form::text('label', null, ['class'=>'col-md-7 col-xs-12 form-control', 'id' => "label", 'placeholder' => "Ex: Utilizadores, Permissões"]) !!}
                </div>
            </div>
        </div>
        <!-- End: Tab -->
