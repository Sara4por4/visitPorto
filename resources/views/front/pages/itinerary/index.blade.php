...
<div class="top-banner top-banner--sec">
  <div class="top-banner__bg" style="background-image:url(front/img/photos/photo7.png)"></div>
  <div class="top-banner__caption-wrap">
    <div class="top-banner__caption">
      <h4 class="top-banner__subtitle subtitle">Roteiros</h4>
      <h1 class="top-banner__big-title big-title">Circuitos turísticos</h1>
    </div>
   ...
   <div class="container">
     ...
     <div class="cards-list row">
       <div class="cards-list__el col-sm-4 col-md-3">
         @include('front.components.teaser-card-author', [
          'class'=>'big',
